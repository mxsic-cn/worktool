package cn.siqishangshu.domain;
...
public class DomainDetection {
    static final String goodDomainPath = "cn/siqishangshu/domain/resource/goodDomain.txt";
    static final String badDomainPath = "cn/siqishangshu/domain/resource/badDomain.txt";
