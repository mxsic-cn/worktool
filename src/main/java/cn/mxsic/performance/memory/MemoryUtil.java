...
public class MemoryUtil {
    ...
    public static void main(String[] agrs) {
        ...
        System.out.println("使用的最大内存量：" + runtime.maxMemory() / 1024L / 1024L + "M");
        System.out.println("内存总量：" + runtime.totalMemory() / 1024L / 1024L + "M");
    }

    public static void freeMemory() {
        System.out.println("空闲内存量：" + Runtime.getRuntime().freeMemory() / 1024L / 1024L + "MB");
    }

    public static void maxMemory() {
        System.out.println("使用的最大内存量：" + Runtime.getRuntime().maxMemory() / 1024L / 1024L + "MB");
    }

    public static void totalMemory() {
        System.out.println("内存总量：" + Runtime.getRuntime().totalMemory() / 1024L / 1024L + "MB");
    }
