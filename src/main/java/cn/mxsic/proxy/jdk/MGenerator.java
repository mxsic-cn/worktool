...
/**
 * Function: MGenerator <br>
 *
 * Source code recreated from a .class file by IntelliJ IDEA
 * (powered by Fernflower decompiler)
 *
 * @author: siqishangshu <br>
 * @date: 2019-09-23 16:37:00
 */
public class MGenerator {
    ...
    private MGenerator.ConstantPool cp = new MGenerator.ConstantPool();
    private List<MGenerator.FieldInfo> fields = new ArrayList();
    private List<MethodInfo> methods = new ArrayList();
    private Map<String, List<MGenerator.ProxyMethod>> proxyMethods = new HashMap();
    private int proxyMethodCount = 0;

    public static byte[] generateProxyClass(String var0, Class<?>[] var1) {
        return generateProxyClass(var0, var1, CLASSFILE_MAJOR_VERSION);
    }

    public static byte[] generateProxyClass(final String var0, Class<?>[] var1, int var2) {
        MGenerator var3 = new MGenerator(var0, var1, var2);
    ...
    private MGenerator(String var1, Class<?>[] var2, int var3) {
        this.className = var1;
    ...
    private byte[] generateClassFile() {
        ...
        try {
            ...
            while (var11.hasNext()) {
                ...
                while (var15.hasNext()) {
                    MGenerator.ProxyMethod var16 = (MGenerator.ProxyMethod) var15.next();
                    this.fields.add(new MGenerator.FieldInfo(var16.methodFieldName, "Ljava/lang/reflect/Method;", 10));
        ...
        if (this.methods.size() > 65535) {
            ...
            try {
                ...
                var14.writeShort(this.cp.getClass(superclassName));
                ...
                while (var15.hasNext()) {
                    MGenerator.FieldInfo var20 = (MGenerator.FieldInfo) var15.next();
                    var20.write(var14);
                }
                ...
                while (var15.hasNext()) {
                    MGenerator.MethodInfo var21 = (MGenerator.MethodInfo) var15.next();
                    var21.write(var14);
                }
    ...
    private void addProxyMethod(Method var1, Class<?> clazz) {
        String methodName = var1.getName();
        Class[] parameterTypes = var1.getParameterTypes();
        Class returnType = var1.getReturnType();
        Class[] exceptionTypes = var1.getExceptionTypes();
        String desc = methodName + getParameterDescriptors(parameterTypes);
        List<ProxyMethod> var8 = this.proxyMethods.get(desc);
        if (var8 != null) {
            Iterator iterator = ((List) var8).iterator();

            while (iterator.hasNext()) {
                MGenerator.ProxyMethod var10 = (MGenerator.ProxyMethod) iterator.next();
                if (returnType == var10.returnType) {
                    ArrayList arr = new ArrayList();
                    collectCompatibleTypes(exceptionTypes, var10.exceptionTypes, arr);
                    collectCompatibleTypes(var10.exceptionTypes, exceptionTypes, arr);
                    var10.exceptionTypes = new Class[arr.size()];
                    var10.exceptionTypes = (Class[]) arr.toArray(var10.exceptionTypes);
                    return;
                }
            }
        } else {
            var8 = new ArrayList(3);
            this.proxyMethods.put(desc, var8);
        }

        var8.add(new MGenerator.ProxyMethod(methodName, parameterTypes, returnType, exceptionTypes, clazz));
    }

    private static void checkReturnTypes(List<MGenerator.ProxyMethod> var0) {
        if (var0.size() >= 2) {
            ...
            do {
                while (var2.hasNext()) {
                    MGenerator.ProxyMethod var3 = (MGenerator.ProxyMethod) var2.next();
                ...
                if (var1.size() > 1) {
                    MGenerator.ProxyMethod var8 = (MGenerator.ProxyMethod) var0.get(0);
    ...
    private MGenerator.MethodInfo generateConstructor() throws IOException {
        MGenerator.MethodInfo var1 = new MGenerator.MethodInfo("<init>", "(Ljava/lang/reflect/InvocationHandler;)V", 1);
        DataOutputStream var2 = new DataOutputStream(var1.code);
        this.code_aload(0, var2);
        this.code_aload(1, var2);
        var2.writeByte(183);
        var2.writeShort(this.cp.getMethodRef(superclassName, "<init>", "(Ljava/lang/reflect/InvocationHandler;)V"));
        var2.writeByte(177);
        var1.maxStack = 10;
        var1.maxLocals = 2;
    ...
    private MGenerator.MethodInfo generateStaticInitializer() throws IOException {
        MGenerator.MethodInfo var1 = new MGenerator.MethodInfo("<clinit>", "()V", 8);
        byte var2 = 1;
        byte var4 = 0;
        ...
        while (var7.hasNext()) {
            ...
            while (var9.hasNext()) {
                MGenerator.ProxyMethod var10 = (MGenerator.ProxyMethod) var9.next();
        ...
        var1.exceptionTable.add(new MGenerator.ExceptionTableEntry(var4, var5, var3, this.cp.getClass("java/lang/NoSuchMethodException")));
        ...
        var1.exceptionTable.add(new MGenerator.ExceptionTableEntry(var4, var5, var3, this.cp.getClass("java/lang/ClassNotFoundException")));
        this.code_astore(var2, var6);
        var6.writeByte(187);
    ...
    private static String getFieldType(Class<?> var0) {
        if (var0.isPrimitive()) {
            return MGenerator.PrimitiveTypeInfo.get(var0).baseTypeString;
        } else {
    ...
    private static class ConstantPool {
        private List<MGenerator.ConstantPool.Entry> pool;
        ...
        public short getClass(String var1) {
            ...
            return this.getIndirect(new MGenerator.ConstantPool.IndirectEntry(7, var2));
        }

        public short getString(String var1) {
            short var2 = this.getUtf8(var1);
            return this.getIndirect(new MGenerator.ConstantPool.IndirectEntry(8, var2));
        }
        ...
        public short getFieldRef(String var1, String var2, String var3) {
            ...
            return this.getIndirect(new MGenerator.ConstantPool.IndirectEntry(9, var4, var5));
        }

        public short getMethodRef(String var1, String var2, String var3) {
            short var4 = this.getClass(var1);
            short var5 = this.getNameAndType(var2, var3);
            return this.getIndirect(new MGenerator.ConstantPool.IndirectEntry(10, var4, var5));
        }

        public short getInterfaceMethodRef(String var1, String var2, String var3) {
            short var4 = this.getClass(var1);
            short var5 = this.getNameAndType(var2, var3);
            return this.getIndirect(new MGenerator.ConstantPool.IndirectEntry(11, var4, var5));
        }

        public short getNameAndType(String var1, String var2) {
            short var3 = this.getUtf8(var1);
            short var4 = this.getUtf8(var2);
            return this.getIndirect(new MGenerator.ConstantPool.IndirectEntry(12, var3, var4));
        }
        ...
        public void write(OutputStream var1) throws IOException {
            ...
            while (var3.hasNext()) {
                MGenerator.ConstantPool.Entry var4 = (MGenerator.ConstantPool.Entry) var3.next();
                var4.write(var2);
            }

        }

        private short addEntry(MGenerator.ConstantPool.Entry var1) {
            this.pool.add(var1);
        ...
        private short getValue(Object var1) {
            ...
            if (var2 != null) {
                ...
                short var3 = this.addEntry(new MGenerator.ConstantPool.ValueEntry(var1));
                this.map.put(var1, new Short(var3));
                return var3;
            }
        }

        private short getIndirect(MGenerator.ConstantPool.IndirectEntry var1) {
            Short var2 = (Short) this.map.get(var1);
            if (var2 != null) {
                return var2;
            } else if (this.readOnly) {
        ...
        private static class IndirectEntry extends MGenerator.ConstantPool.Entry {
            private int tag;
            ...
            public boolean equals(Object var1) {
                if (var1 instanceof MGenerator.ConstantPool.IndirectEntry) {
                    MGenerator.ConstantPool.IndirectEntry var2 = (MGenerator.ConstantPool.IndirectEntry) var1;
        ...
        private static class ValueEntry extends MGenerator.ConstantPool.Entry {
    ...
    private static class PrimitiveTypeInfo {
        ...
        private static Map<Class<?>, MGenerator.PrimitiveTypeInfo> table = new HashMap();

        private static void add(Class<?> var0, Class<?> var1) {
            table.put(var0, new MGenerator.PrimitiveTypeInfo(var0, var1));
        }
        ...
        private PrimitiveTypeInfo(Class<?> var1, Class<?> var2) {
            ...
            this.wrapperClassName = MGenerator.dotToSlash(var2.getName());
        ...
        public static MGenerator.PrimitiveTypeInfo get(Class<?> var0) {
            return (MGenerator.PrimitiveTypeInfo) table.get(var0);
        }
    ...
    private class ProxyMethod {
        ...
        private ProxyMethod(String methodName, Class<?>[] parameterTypes, Class<?> returnType, Class<?>[] exceptionTypes, Class<?> clazz) {
            this.methodName = methodName;
            this.parameterTypes = parameterTypes;
            this.returnType = returnType;
            this.exceptionTypes = exceptionTypes;
            this.fromClass = clazz;
            this.methodFieldName = "m" + MGenerator.this.proxyMethodCount++;
        }

        private MGenerator.MethodInfo generateMethod() throws IOException {
            String var1 = MGenerator.getMethodDescriptor(this.parameterTypes, this.returnType);
            MGenerator.MethodInfo var2 = MGenerator.this.new MethodInfo(this.methodName, var1, 17);
            int[] var3 = new int[this.parameterTypes.length];
            int var4 = 1;

            for (int var5 = 0; var5 < var3.length; ++var5) {
                var3[var5] = var4;
                var4 += MGenerator.getWordsPerType(this.parameterTypes[var5]);
            }

            byte var7 = 0;
            DataOutputStream var9 = new DataOutputStream(var2.code);
            MGenerator.this.code_aload(0, var9);
            var9.writeByte(180);
            var9.writeShort(MGenerator.this.cp.getFieldRef(superclassName, handlerFieldName, "Ljava/lang/reflect/InvocationHandler;"));
            MGenerator.this.code_aload(0, var9);
            var9.writeByte(178);
            var9.writeShort(MGenerator.this.cp.getFieldRef(MGenerator.dotToSlash(MGenerator.this.className), this.methodFieldName, "Ljava/lang/reflect/Method;"));
            if (this.parameterTypes.length > 0) {
                MGenerator.this.code_ipush(this.parameterTypes.length, var9);
                var9.writeByte(189);
                var9.writeShort(MGenerator.this.cp.getClass("java/lang/Object"));

                for (int var10 = 0; var10 < this.parameterTypes.length; ++var10) {
                    var9.writeByte(89);
                    MGenerator.this.code_ipush(var10, var9);
            ...
            var9.writeByte(185);
            var9.writeShort(MGenerator.this.cp.getInterfaceMethodRef("java/lang/reflect/InvocationHandler", "invoke", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;"));
            var9.writeByte(4);
            var9.writeByte(0);
            ...
            List var13 = MGenerator.computeUniqueCatchList(this.exceptionTypes);
            if (var13.size() > 0) {
                Iterator var11 = var13.iterator();

                while (var11.hasNext()) {
                    Class var12 = (Class) var11.next();
                    var2.exceptionTable.add(new MGenerator.ExceptionTableEntry(var7, var8, var6, MGenerator.this.cp.getClass(MGenerator.dotToSlash(var12.getName()))));
                }

                var9.writeByte(191);
                var6 = (short) var2.code.size();
                var2.exceptionTable.add(new MGenerator.ExceptionTableEntry(var7, var8, var6, MGenerator.this.cp.getClass("java/lang/Throwable")));
                MGenerator.this.code_astore(var4, var9);
                var9.writeByte(187);
                var9.writeShort(MGenerator.this.cp.getClass("java/lang/reflect/UndeclaredThrowableException"));
                var9.writeByte(89);
                MGenerator.this.code_aload(var4, var9);
                var9.writeByte(183);
                var9.writeShort(MGenerator.this.cp.getMethodRef("java/lang/reflect/UndeclaredThrowableException", "<init>", "(Ljava/lang/Throwable;)V"));
                var9.writeByte(191);
            }
            ...
            if (var2.code.size() > 65535) {
                ...
                for (int var14 = 0; var14 < this.exceptionTypes.length; ++var14) {
                    var2.declaredExceptions[var14] = MGenerator.this.cp.getClass(MGenerator.dotToSlash(this.exceptionTypes[var14].getName()));
                }
        ...
        private void codeWrapArgument(Class<?> var1, int var2, DataOutputStream var3) throws IOException {
            if (var1.isPrimitive()) {
                MGenerator.PrimitiveTypeInfo var4 = MGenerator.PrimitiveTypeInfo.get(var1);
                if (var1 != Integer.TYPE && var1 != Boolean.TYPE && var1 != Byte.TYPE && var1 != Character.TYPE && var1 != Short.TYPE) {
                    if (var1 == Long.TYPE) {
                        MGenerator.this.code_lload(var2, var3);
                    } else if (var1 == Float.TYPE) {
                        MGenerator.this.code_fload(var2, var3);
                    } else {
                        if (var1 != Double.TYPE) {
                            throw new AssertionError();
                        }

                        MGenerator.this.code_dload(var2, var3);
                    }
                } else {
                    MGenerator.this.code_iload(var2, var3);
                }

                var3.writeByte(184);
                var3.writeShort(MGenerator.this.cp.getMethodRef(var4.wrapperClassName, "valueOf", var4.wrapperValueOfDesc));
            } else {
                MGenerator.this.code_aload(var2, var3);
            }
        ...
        private void codeUnwrapReturnValue(Class<?> var1, DataOutputStream var2) throws IOException {
            if (var1.isPrimitive()) {
                MGenerator.PrimitiveTypeInfo var3 = MGenerator.PrimitiveTypeInfo.get(var1);
                var2.writeByte(192);
                var2.writeShort(MGenerator.this.cp.getClass(var3.wrapperClassName));
                var2.writeByte(182);
                var2.writeShort(MGenerator.this.cp.getMethodRef(var3.wrapperClassName, var3.unwrapMethodName, var3.unwrapMethodDesc));
                if (var1 != Integer.TYPE && var1 != Boolean.TYPE && var1 != Byte.TYPE && var1 != Character.TYPE && var1 != Short.TYPE) {
                    if (var1 == Long.TYPE) {
                        var2.writeByte(173);
                    } else if (var1 == Float.TYPE) {
                ...
                var2.writeByte(192);
                var2.writeShort(MGenerator.this.cp.getClass(MGenerator.dotToSlash(var1.getName())));
                var2.writeByte(176);
            }
        ...
        private void codeFieldInitialization(DataOutputStream var1) throws IOException {
            MGenerator.this.codeClassForName(this.fromClass, var1);
            MGenerator.this.code_ldc(MGenerator.this.cp.getString(this.methodName), var1);
            MGenerator.this.code_ipush(this.parameterTypes.length, var1);
            var1.writeByte(189);
            var1.writeShort(MGenerator.this.cp.getClass("java/lang/Class"));

            for (int var2 = 0; var2 < this.parameterTypes.length; ++var2) {
                var1.writeByte(89);
                MGenerator.this.code_ipush(var2, var1);
                if (this.parameterTypes[var2].isPrimitive()) {
                    MGenerator.PrimitiveTypeInfo var3 = MGenerator.PrimitiveTypeInfo.get(this.parameterTypes[var2]);
                    var1.writeByte(178);
                    var1.writeShort(MGenerator.this.cp.getFieldRef(var3.wrapperClassName, "TYPE", "Ljava/lang/Class;"));
                } else {
                    MGenerator.this.codeClassForName(this.parameterTypes[var2], var1);
                }
            ...
            var1.writeByte(182);
            var1.writeShort(MGenerator.this.cp.getMethodRef("java/lang/Class", "getMethod", "(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;"));
            var1.writeByte(179);
            var1.writeShort(MGenerator.this.cp.getFieldRef(MGenerator.dotToSlash(MGenerator.this.className), this.methodFieldName, "Ljava/lang/reflect/Method;"));
        }
    }
    ...
    private class MethodInfo {
        ...
        public List<MGenerator.ExceptionTableEntry> exceptionTable = new ArrayList();
        ...
        public MethodInfo(String var2, String var3, int var4) {
            ...
            MGenerator.this.cp.getUtf8(var2);
            MGenerator.this.cp.getUtf8(var3);
            MGenerator.this.cp.getUtf8("Code");
            MGenerator.this.cp.getUtf8("Exceptions");
        }

        public void write(DataOutputStream var1) throws IOException {
            var1.writeShort(this.accessFlags);
            var1.writeShort(MGenerator.this.cp.getUtf8(this.name));
            var1.writeShort(MGenerator.this.cp.getUtf8(this.descriptor));
            var1.writeShort(2);
            var1.writeShort(MGenerator.this.cp.getUtf8("Code"));
            ...
            while (var2.hasNext()) {
                MGenerator.ExceptionTableEntry var3 = (MGenerator.ExceptionTableEntry) var2.next();
            ...
            var1.writeShort(0);
            var1.writeShort(MGenerator.this.cp.getUtf8("Exceptions"));
